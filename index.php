    ...
    <section class="list-bazar" id="daftar-bazar">
        ...
        <div class="bazar-group">
            <div class="event-group">
                <a href=""><img src="asset-beranda/Bazar Lions Club.jpeg" alt="" /></a>
                <div>
                    <p class="date">
                    ...
                    <a href="#">Bazar: Lions Club Pekanbaru UMKM</a>
                    <p>Sebuah acara yang menghadirkan beragam produk unggulan dari pelaku Usaha Mikro, Kecil, dan Menengah (UMKM) di Pekanbaru. Dapatkan kesempatan untuk mendukung bisnis lokal sambil menikmati berbagai penawaran menarik dan inovasi dari para...</p>
                </div>
            </div>  

            <div class="event-group">
                <a href=""><img src="asset-beranda/Bazar Ramadhan.png" alt="" /></a>
                <div>
                    <p class="date">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" style="margin-right: 10px;">
                            <g clip-path="url(#clip0_434_132)">
                        ...
                        </svg> Desember 10, 2024
                    </p>
                    <a href="#">Bazar Ramadhan Masjid Agung</a>
                    <p>Selamat datang di Bazar Ramadhan Masjid Agung, tempat yang tepat untuk memenuhi kebutuhan sahur dan berbuka puasa Anda! Nikmati berbagai pilihan makanan dan minuman lezat, serta produk-produk lokal berkualitas dari para pelaku usaha...</p>
                </div>
            </div>  

            <div class="event-group">
                <a href=""><img src="asset-beranda/Bazar Nusantara.jpg" alt="" /></a>
                <div>
                    <p class="date">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" style="margin-right: 10px;">
                            <g clip-path="url(#clip0_434_132)">
                    ...
                    <a href="#">Bazar Kuliner Nusantara</a>
                    <p>Bergabunglah dengan kami di Bazar Kuliner Nusantara, sebuah acara yang merayakan keberagaman cita rasa dan kelezatan masakan dari seluruh penjuru Indonesia! Nikmati berbagai hidangan autentik dari berbagai daerah, mulai dari makanan tradisional...</p>
                </div>
            </div>  
        </div>    
    </section>
